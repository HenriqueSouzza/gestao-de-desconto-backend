...
class CreateDiscountMarginSchoolarshipsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('discount_margin_schoolarships', function (Blueprint $table) {
            ...
            $table->string('id_rm_discount_margin_schoolarship',10)->comment('ID da bolsa do RM tabela SBOLSA');
            ...
            $table->integer('id_rm_modality_discount_margin_schoolarship')->comment('ID da molidade do RM presencial ou EAD, CAMPO: CURPRESDIST');
            $table->integer('id_rm_major_discount_margin_schoolarship')->comment('ID do Curso tabela SCURSO, CAMPO: CODCURSO');
            ...
            $table->decimal('max_value_discount_margin_schoolarship',3,2)->comment("Valor máximo");
